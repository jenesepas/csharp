...
namespace Puche
{
    ...
    {        
        ...
        public static List<Registro> Buscar(char pt_deleg, int pn_reg, int pfra,char pt_cte, string pn_cte, string pexp)
        {
            string sql;
            List<Registro> _lista = new List<Registro>();            

            if (pt_deleg == ' ' & pn_reg == 0 & pfra == 0 & pt_cte == ' ' & pn_cte ==  " " & pexp == " ") //consulta todos los registros. (Mregistros)
            ...
            using (BDConexion.ObtenerConexion())
            {
                ...
                while (datos.Read())
                {
                    ...
                    pRegistro.et_tasa = datos.GetInt32(18); 
                    ...
                    pRegistro.et_tasa2 = datos.GetInt32(25);
                    pRegistro.t_tasa2 = datos.GetString(26);
                    pRegistro.et_tasa3 = datos.GetInt32(27);
                    pRegistro.t_tasa3 = datos.GetString(28);
                    pRegistro.et_tasa4 = datos.GetInt32(29);
        ...
        public static Registro ObtenerReg(char pdeleg, int pn_reg)
        {
            ...
            using (BDConexion.ObtenerConexion())
            {
                ...
                while (datos.Read())
                {
                    ...
                    pRegistro.exp_tl = datos.GetString(16);
                    pRegistro.fec_pre_exp = datos.GetDateTime(17);
                    pRegistro.et_tasa = datos.GetInt32(18); //(float)datos.GetDecimal(18);
                    pRegistro.t_tasa = datos.GetString(19);
                    pRegistro.cambio_serv = datos.GetString(20);
                    pRegistro.bate_ant = datos.GetString(21);
                    pRegistro.nif = datos.GetString(22);
