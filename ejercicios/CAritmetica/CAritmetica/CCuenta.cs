 ...
 */ 
    class CCuenta
    {
        ...
        public CCuenta(string nom, string cta, double sald, double ti)
        {
            nombre = nom;
            cuenta = cta;
            saldo = sald;
        ...
        {
            System.Console.WriteLine("Nombre: " + this.obtenerNombre());
            System.Console.WriteLine("Cta.: " + this.obtenerCta());
            System.Console.WriteLine("Saldo: " + this.estado());
            System.Console.WriteLine("Tipo Int.: " + this.obtenerTipoDeInteres());
        }
    }
