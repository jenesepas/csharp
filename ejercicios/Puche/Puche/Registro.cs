...
namespace Puche
{
    public class Registro
    {
        ...
        public long et_tasa2 { get; set; }
        public string t_tasa2 { get; set; }
        public long et_tasa3 { get; set; }
        public string t_tasa3 { get; set; }
        public long et_tasa4 { get; set; }
        public string t_tasa4 { get; set; }
        public string descripcion { get; set; }
        public string ruta_pdf { get; set; }
        public string vehiculo { get; set; }
        public string descrip1 { get; set; }
        public decimal impor1 { get; set; }
        public bool iva1_sn { get; set; }
        public string descrip2 { get; set; }
        public decimal impor2 { get; set; }
        public bool iva2_sn { get; set; }
        ...
        public Registro(char pdelegacion, int pn_reg, DateTime pfec_ent, int pid_cte, int pid_titular, string pseccion_int, 
                        ...
                        long pet_tasa4, string pt_tasa4, string pdescripcion, string pruta_pdf, string pvehiculo, string pdescrip1, decimal pimpor1, bool piva1_sn,
                        string pdescrip2, decimal pimpor2, bool piva2_sn)
        {
            ...
            this.descrip1 = pdescrip1;
            this.impor1 = pimpor1;
            this.iva1_sn = piva1_sn;
            this.descrip2 = pdescrip2;
            this.impor2 = pimpor2;
            this.iva2_sn = piva2_sn;
        }
    }
}
