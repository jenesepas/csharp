...
namespace Asegest
{
    public partial class Rpt_RegASI : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, PrintPageEventArgs ev)
        {
            ...
            ev.Graphics.DrawLine(new Pen(Color.Black, 2), xPos, yPos + 70, xPos + 1080, yPos + 70);
        ...
        private void btt_imp_ac_rg_si_Click(object sender, EventArgs e)
        {
            lanza_lfra();
            Iniciar_lreg();
            //this.Close();
        ...
        private void btt_cancelar_ac_rg_si_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void Rpt_RegASI_Load(object sender, EventArgs e)
        {
            Iniciar_lreg();
        }
