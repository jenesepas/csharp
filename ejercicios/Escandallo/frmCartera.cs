...
namespace cartera
{
    public partial class frmCartera : Form
    {
        ...
        private void configuraDataGridView(int indiceFila, bool soloLectura)
        {
            ...
            this.dgvRejillaDatos.Rows[indiceFila].Cells["CodArtic"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["CodArtic"].Style.BackColor = this.colorReadOnly;
            //this.dgvRejillaDatos.Rows[indiceFila].Cells["CodArtic"].Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["CodArtic"].Value = "";

            this.dgvRejillaDatos.Rows[indiceFila].Cells["DescripArtic"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["DescripArtic"].Style.BackColor = this.colorReadOnly;
            //this.dgvRejillaDatos.Rows[indiceFila].Cells["DescripArtic"].Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["DescripArtic"].Value = "";

            this.dgvRejillaDatos.Rows[indiceFila].Cells["Cantidad"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Cantidad"].Style.BackColor = this.colorReadWrite; 
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Cantidad"].Style.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Cantidad"].Value = "";

            this.dgvRejillaDatos.Rows[indiceFila].Cells["Unidad"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Unidad"].Style.BackColor = this.colorReadOnly;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Unidad"].Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Unidad"].Value = "";

            this.dgvRejillaDatos.Rows[indiceFila].Cells["Coste"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Coste"].Style.BackColor = this.colorReadWrite; 
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Coste"].Style.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Coste"].Value = "";

            this.dgvRejillaDatos.Rows[indiceFila].Cells["Precio"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Precio"].Style.BackColor = this.colorReadWrite; 
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Precio"].Style.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Precio"].Value = "";

            this.dgvRejillaDatos.Rows[indiceFila].Cells["Largo"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Largo"].Style.BackColor = this.colorReadOnly; 
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Largo"].Style.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Largo"].Value = "";

            this.dgvRejillaDatos.Rows[indiceFila].Cells["Ancho"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Ancho"].Style.BackColor = this.colorReadOnly;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Ancho"].Style.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Ancho"].Value = "";
            
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Fondo"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Fondo"].Style.BackColor = this.colorReadOnly;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Fondo"].Style.Alignment = DataGridViewContentAlignment.MiddleRight;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Fondo"].Value = "";

            this.dgvRejillaDatos.Rows[indiceFila].Cells["Semielaborado"].ReadOnly = soloLectura;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Semielaborado"].Style.BackColor = this.colorReadOnly;
            this.dgvRejillaDatos.Rows[indiceFila].Cells["Semielaborado"].Value = 0;
        }
        ...
        private void consultaDatos(string codigoClienteConsulta)
        {
            ...
            columnaDgw = new DataGridViewTextBoxColumn();
            columnaDgw.HeaderText = "Artículo";
            columnaDgw.Name = "CodArtic";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 100;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);

            columnaDgw = new DataGridViewTextBoxColumn();
            columnaDgw.HeaderText = "Descripción Artículo";
            columnaDgw.Name = "DescripArtic";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 300;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);
            
            columnaDgw = new DataGridViewTextBoxColumn();
            columnaDgw.HeaderText = "Cantidad";
            columnaDgw.Name = "Cantidad";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 80;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);

            columnaDgw = new DataGridViewTextBoxColumn();
            columnaDgw.HeaderText = "Unidad";
            columnaDgw.Name = "Unidad";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 80;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);

            columnaDgw = new DataGridViewTextBoxColumn();
            columnaDgw.HeaderText = "Coste";
            columnaDgw.Name = "Coste";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 80;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);

            columnaDgw = new DataGridViewTextBoxColumn(); // CalendarColumn();
            columnaDgw.HeaderText = "Precio";
            columnaDgw.Name = "Precio";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 80;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);                        

            columnaDgw = new DataGridViewTextBoxColumn();
            columnaDgw.HeaderText = "Largo";
            columnaDgw.Name = "Largo";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 80;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);

            columnaDgw = new DataGridViewTextBoxColumn();
            columnaDgw.HeaderText = "Ancho";
            columnaDgw.Name = "Ancho";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 80;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);

            columnaDgw = new DataGridViewTextBoxColumn();
            columnaDgw.HeaderText = "Fondo";
            columnaDgw.Name = "Fondo";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 80;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);

            columnaDgw = new DataGridViewCheckBoxColumn();
            columnaDgw.HeaderText = "Semielaborado";
            columnaDgw.Name = "Semielaborado";
            columnaDgw.Resizable = DataGridViewTriState.False;
            columnaDgw.Width = 80;
            this.dgvRejillaDatos.Columns.Add(columnaDgw);
            ...
            //    nombreCliente = Convert.ToString(this.tablaClientes.Rows[0].ItemArray[8]);
                ...
                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["CodArtic"].Value = "BARRA120";

                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["DescripArtic"].Value = "BARRA Nº 120"; 

                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["Cantidad"].Value = "4"; 

                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["Unidad"].Value = "m3";

                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["Coste"].Value = "0.13";

                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["Precio"].Value = "5,87";

                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["Largo"].Value = "180";

                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["Ancho"].Value = "20"; 

                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["Fondo"].Value = "10"; 

                this.dgvRejillaDatos.Rows[indiceRegistro].Cells["Semielaborado"].Value = semielaborado;
